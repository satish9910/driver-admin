  ...
  const fetchDeliveryPartners = async () => {
    try {
      ...
      if (response.data.verified) {
        setDeliveryPartners(response.data.verified);
      } else {
        toast({
          title: "Error",
          description: response.data.message || "Failed to fetch delivery partners.",
          variant: "destructive",
        });
      }
    } catch (error) {
            ...
            <TableBody>
              {filteredPartners?.map((partner, index) => (
                <TableRow key={partner.id}>
                  ...
                  <TableCell>
                    <Badge className={getStatusColor(partner.isActive ? "active" : "inactive")}>
                  ...
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem
                          onClick={() => window.location.href = `/admin/partnerprofile/${partner.id}`}
                        >
